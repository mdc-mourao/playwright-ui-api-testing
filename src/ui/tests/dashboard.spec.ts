...
test.describe('@B3 @UI Test Automation - Dashboard Tests', () => {
    ...
    test('Verify that key dashboard elements/widgets are visible and rendered', async ({ loginPage, dashboardPage }) => {      
    ...
    const menuItems = [
        ...
        { name: 'Performance', path: '/performance/searchEvaluatePerformanceReview' },
